...
<body class="layout-documentation has-navbar-fixed-top">
  ...
  <section class="main-content columns is-centered is-fullheight" style="margin-top: 6%; margin-bottom: 4%">
    <div class="column is-7">
      <div class="card">
      <a class="button is-white is-rounded is-small" href="{{index}}?properties">
        ...
        <div class="card-content pt-0">
          <div class="content mt-5" style="font-size: 0.95em">
            <p class="has-text-weight-medium is-size-5 mb-5" style="color: #004080">{{parent}}.{{name}} {{access}}</p>
            <p>{{description}}</p>
