...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"
        rel="stylesheet" />
  <link href="https://luart.org/doc/{{module}}/{{filename}}" rel="canonical" />
...
<body class="layout-documentation has-navbar-fixed-top">
  ...
  <section class="main-content columns is-centered is-fullheight" style="margin-top: 6%; margin-bottom: 4%">
    <div class="column is-7">
      <div class="card">
      <a class="button is-white is-rounded is-small" href="{{parent}}.html?operations">
        <span class="icon has-text-grey-lighter">
          <i class="fas fa-circle-left is-size-5"></i>
        </span>
      </a>
        <div class="card-content pt-0">
          <div class="content mt-5" style="font-size: 0.85em">
           <p class="has-text-weight-medium is-size-5 mb-5" style="color: #004080; vertical-align: middle">{{title}}</p>
            {{description}}
{{example}}
