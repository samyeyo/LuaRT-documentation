...
<head>
  ...
  <meta content="LuaRT modules documentation" name="description" />
  <title>
    LuaRT Modules reference
  </title>
  <link href="../css/bulma-docs.min.css" rel="stylesheet" />
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"
        rel="stylesheet" />
  <link href="https://luart.org/doc/modules.html" rel="canonical" />
    ...
    <div class="column is-7">
      <div class="card">
        ...
        <div class="card-content">
          <p class="has-text-centered is-size-3 has-text-weight-medium mb-0" style="color: #004080; margin-top:-3%">Lua<sup>rt</sup> modules reference</p>
        <div class="bd-single-content content mt-6 mb-6">
