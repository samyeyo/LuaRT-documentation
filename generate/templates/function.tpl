...
<head>
  ...
  <meta name="description" content="{{tinydesc}}" />
  <title>
    {{fullname}}()
  </title>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"
        rel="stylesheet" />
  <link href="https://luart.org/doc/{{parent}}/{{filename}}" rel="canonical" />
...
<body class="layout-documentation has-navbar-fixed-top">
  ...
  <section class="main-content columns is-centered is-fullheight" style="margin-top: 6%; margin-bottom: 4%">
    <div class="column is-7">
      <div class="card">
        <a class="button is-white is-rounded is-small" href="{{index}}?{{list}}">
          <span class="icon has-text-grey-lighter">
            <i class="fas fa-circle-left is-size-5"></i>
          </span>
        </a>
        <div class="card-content pt-0">
          <div class="content mt-5" style="font-size:0.95em;">
            <p class="has-text-weight-medium is-size-5 mb-5" style="color: #004080; vertical-align: middle">{{fullname}}({{paramlist}})<span class ="tag is-rounded has-text-weight-medium {{color}} ml-2 is-size-7" style="vertical-align: middle;">{{funckind}}</p>
            <p>{{description}}</p>
            {{parameters}}
            <p class="has-text-weight-medium is-size-6 mb-1 mt-5" style="color: #004080">Return value</p>
            {{returns}}
            <p class="has-text-weight-medium is-size-6 mt-5 mb-0" style="color: #004080">Example</p>
...
<script>
    ...
    codeBlocks.forEach((block) => {
        ...
        copyBtn.innerHTML = `<svg viewBox="0 0 24 24" width="16" height="16"><path fill="none" d="M0 0h24v24H0z"/><path d="M7 6V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1.001 1.001 0 0 1 3 21l.003-14c0-.552.45-1 1.007-1H7zM5.003 8L5 20h10V8H5.003zM9 6h8v10h2V4H9v2z" fill="currentColor"/></svg>`;
